...
<div id="formwrapper">
	<h3>查看用户</h3>
	<form action="MemberServlet?method=update&pageNo=${page.pageNo }&pageSize=${page.pageSize }" method="post">
	...
	<fieldset>
		...
		<div>
			...
			<input type="text" name="age" id="age" value="${member.age }" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
