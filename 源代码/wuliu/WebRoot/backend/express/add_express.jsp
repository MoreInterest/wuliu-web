...
<div id="formwrapper">
	<h3>添加快件</h3>
	<form action="ExpressServlet?method=add"  method="post">
	<fieldset>
		<legend>快件信息</legend>
		<div>
...
<div>
		...
		<div>
			...
			<input type="text" name="chufa" id="chufa" value="" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
			<label for="shoujianname">收件人姓名</label>
			<input type="text" name="shoujianname" id="shoujianname" value="" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
		...
		<div>
			...
			<input type="text" name="place" id="place" value="" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
			<label for="leibie">快件类别</label>
			<input type="text" name="leibie" id="leibie" value="" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
		...
		<div>
			...
			<input type="text" name="state" id="state" value="" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div class="enter">
