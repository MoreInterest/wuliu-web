...
<div id="formwrapper">
	<h3>添加车辆</h3>
	<form action="CarsServlet?method=add"  method="post">
	<fieldset>
		<legend>车辆信息</legend>
		<div>
		...
		<div>
			...
			<input type="text" name="leixing" id="leixing" value="" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
			<label for="zaizhong">载重</label>
			<input type="text" name="zaizhong" id="zaizhong" value="" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
			<label for="xiulicontent">修理记录</label>
			<div style="margin:0px 0px 0px 130px;">
			<textarea rows="10" cols="100" name="xiulicontent" id="xiulicontent" ></textarea>
			</div>
			<br />	
		</div>
		<div>
		...
		<div>
			...
			<input type="text" name="jiayou" id="jiayou" value="" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
			<label for="beizhucontent">备注</label>
			<div style="margin:0px 0px 0px 130px;">
			<textarea rows="10" cols="100" name="beizhucontent" id="beizhucontent" ></textarea>
			</div>
			<br />	
		</div>
		<div>
		...
		<div>
			...
			<div style="margin:0px 0px 0px 130px;">
			<textarea rows="10" cols="100" name="jiashiyuancontent" id="jiashiyuancontent" ></textarea>
			</div>
			<br />	
		</div>
		<div>
		...
		<div>
			...
			<input type="text" name="carno" id="carno" value="" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
			<label for="luxiancontent">路线</label>
			<div style="margin:0px 0px 0px 130px;">
			<textarea rows="10" cols="100" name="luxiancontent" id="luxiancontent" ></textarea>
			</div>
			<br />	
		</div>
		<div>
		...
		<div>
			...
			<input type="text" name="youfei" id="youfei" value="" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div class="enter">
